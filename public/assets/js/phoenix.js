...
const categoriaColores = {
  "CLORO": "#ffcccc", // Rosa claro
  "DETERGENTES": "#ccffcc", // Verde claro
  "LAVANDINA": "#ccccff", // Azul claro
  "DESENGRASANTE": "#ffccff", // Magenta claro
  "DESODORANTE P/PISO": "#ccffff", // Cian claro
  "JABON LIQUIDO": "#ffffcc", // Amarillo claro
  "SUAVIZANTE": "#ffddcc", // Naranja claro
  "JABON P/ MANOS": "#e0ccff", // Púrpura claro
  "LIMPIA VIDRIOS": "#cce0ff", // Azul celeste claro
  "LIMPIADOR ALFOMBRAS": "#ffcc99", // Melocotón claro
      ...
      layout: {
        top1End:{
          buttons: [
            ...
            {
                title: `Dunteva-Lista de precios`,
                ...
                customize: function (docInstancia,botonGenerado,instanciaTabla) {
                  const docInstanciaTabla = docInstancia.content[1].table;
                  docInstanciaTabla.width = ['%5','%5','%5','%5','%5','%5','%5']
                  
                  for(let i= 0; i < docInstanciaTabla.body.length; i++){
                    const categoria = docInstanciaTabla.body[i][3].text;
                    if (categoriaColores[categoria]) {
                  ...
                  //console.log(docInstancia.content[1].table.body[2]);
                  docInstancia.content[1].layout = 'lightHorizontalLines'; // Establece el diseño de la tabla
